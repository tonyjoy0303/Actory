const _jsxFileName = "";import * as SheetPrimitive from "@radix-ui/react-dialog"
...
(({ className, ...props }, ref) => (
  React.createElement(SheetPrimitive.Overlay, {
    ...
    ...props,
    ref: ref, __self: this, __source: {fileName: _jsxFileName, lineNumber: 20}}
  )
))
...
(({ side = "right", className, children, ...props }, ref) => (
  React.createElement(SheetPortal, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 58}}
    , React.createElement(SheetOverlay, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 59}} )
    , React.createElement(SheetPrimitive.Content, {
      ...
      , React.createElement(SheetPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary"             , __self: this, __source: {fileName: _jsxFileName, lineNumber: 66}}
        , React.createElement(X, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 67}} )
