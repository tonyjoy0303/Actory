      ...
      React.createElement('div', {
        ...
        , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 185}}
          , payload.map((item, index) => {
            ...
            const itemConfig = getPayloadConfigFromPayload(config, item, key)
            const indicatorColor = color || _optionalChain([item, 'optionalAccess', _9 => _9.payload, 'optionalAccess', _10 => _10.fill]) || item.color
                ...
                , formatter && _optionalChain([item, 'optionalAccess', _9 => _9.value]) !== undefined && item.name ? (
                  ...
                  React.createElement(React.Fragment, null
                    , _optionalChain([itemConfig, 'optionalAccess', _10 => _10.icon]) ? (
                      React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 204}} )
                    ) : (
                      !hideIndicator && (
                        React.createElement('div', {
                          className: cn(
                    ...
                    , React.createElement('div', {
                      ...
                      , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 233}}
                        , nestLabel ? tooltipLabel : null
                        , React.createElement('span', { className: "text-muted-foreground", __self: this, __source: {fileName: _jsxFileName, lineNumber: 235}}
                          , _optionalChain([itemConfig, 'optionalAccess', _11 => _11.label]) || item.name
                        )
                      )
                      , item.value && (
                        React.createElement('span', { className: "font-mono font-medium tabular-nums text-foreground"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 240}}
        ...
        , payload.map((item) => {
          ...
          return (
            React.createElement('div', {
              ...
              ), __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}}

              , _optionalChain([itemConfig, 'optionalAccess', _13 => _13.icon]) && !hideIcon ? (
                React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 298}} )
              ) : (
                React.createElement('div', {
