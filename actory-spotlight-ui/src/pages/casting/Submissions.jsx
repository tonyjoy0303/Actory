                ...
                , displayedSubmissions.map((s) => (
                  React.createElement('div', { key: s._id, className: "p-3 rounded-md border flex items-center justify-between gap-3" }
                    , React.createElement('div', null
                      ...
                      , s.videoUrl ? React.createElement('div', { className: "mt-2" }
                        , React.createElement('p', { className: "text-xs font-medium mb-1" }, 'Submitted Video:')
                        , React.createElement('video', { src: s.videoUrl, controls: true, className: "w-full max-w-md rounded border bg-black" })
                      ) : null
